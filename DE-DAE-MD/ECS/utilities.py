...
precess_postal_code             Line 174
round_to_nearest_decade         Line 196
process_year                    Line 209
output_dtype                    Line 223
output_missing_rate             Line 237
remove_outliers                 Line 256
output_distribution             Line 279
output_heatmap                  Line 309
count_and_plot_completed_data   Line 325
count_and_plot_missing_data     Line 358
plot_loss                       Line 399
...
def encode_dropna(dataset):
    ...
    '''
    dataset['Type_main_energy_ECS'] = dataset['Type_main_energy_ECS'].replace({
