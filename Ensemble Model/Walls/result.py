...
DAE1 training process           Lines 149
DAE2 training process           Lines 183
DAE3 training process           Lines 218
Result                          Lines 253

If you want to run this function in your local environment, you only need to change one variable:
path_dataset, on line 54, which you need to change to the path where your data is stored.
...
if __name__ == "__main__":
    ...
    df_insulation_walls_imputed_ensemble, mask_ensemble = insert_and_impute_ensemble(x_val, x_true, x_train, target_column, 0.2, dae, dae2, dae3, num_iterations = 1)

    # Test the correct rate of the target column of ensemble when the missing ratio is 10%.
    df_insulation_walls_imputed_ensemble, mask_ensemble = insert_and_impute_ensemble(x_val, x_true, x_train, target_column, 0.1, dae, dae2, dae3, num_iterations = 1)
